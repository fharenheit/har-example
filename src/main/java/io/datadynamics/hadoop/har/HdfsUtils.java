...
public class HdfsUtils {
    ...
    public static final String HAR_URL_PREFIX = "har://";
     ...
     * @return DFS Client
     * @throws IOException DFS Client를 생성할 수 없는 경우
     */
    ...
    public static String getFilename(InputSplit inputSplit) {
        String filename = io.datadynamics.bigdata.mapreduce.util.FileUtils.getFilename(inputSplit.toString());
     ...
     * @param hdfsUrl HDFS URL
     * @return FileSystem
     * @throws IOException FileSystem을 얻을 수 없는 경우
     */
    ...
    public static void saveFile(DFSClient client, String path, String content) throws IOException {
        ...
        io.datadynamics.bigdata.mapreduce.util.FileUtils.copy(content.getBytes(), outputStream);
        outputStream.close();
    }
     ...
     * @throws IOException 파일을 복사할 수 없는 경우
     */
    public static void copyFromLocalFileToHdfsFile(File inputFile, DFSClient client, String hdfsPath) throws IOException {
        ...
        io.datadynamics.bigdata.mapreduce.util.FileUtils.copy(inputStream, outputStream);
    }
     ...
     * @throws IOException HDFS에 접근할 수 없거나, 파일 목록을 알아낼 수 없는 경우
     */
